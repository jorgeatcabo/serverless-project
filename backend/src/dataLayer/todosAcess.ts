...
//With line above showed the error:
//Property 'DocumentClient' does not exist on type 'PatchedAWSClientConstructor<ServiceConfigurationOptions
//in return new XAWS.DynamoDB.DocumentClient()
